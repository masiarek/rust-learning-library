...
- **A temporary drops at the end of the statement that built it**, not at the end of the block. (`match` and `if let` scrutinees are the interesting case, and edition 2024 changed when theirs drop — see [`if let`](../if_let/README.md).)
