...
| [Concatenating strings](concatenating_strings/README.md) | 101 → 201 | Why `"a" + "b"` is `E0369` — the one `Add` impl there is, the three ways to say it instead, and `join` once there are more than two pieces |
