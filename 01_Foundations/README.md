...
| [Ownership](../18_Ownership/README.md) | 10 | One owner per value, what a move actually transfers, borrowing, and the three questions the word "scope" collapses into one |
