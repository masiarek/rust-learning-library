...
- [What is a ballot, in memory?](../representing_a_ballot/README.md) — the layer above, where those bytes become a container you chose
- [Six kinds of zero](../six_kinds_of_zero/README.md) — the sentinel argument, which is the same mistake as an unpadded fingerprint: meaning the type cannot see
