...
Without that rule, `view` would point into freed memory the moment a push reallocates. The [borrowing](../borrowing/README.md) rules are not string-specific — but a growable buffer is where they earn their keep most visibly.
