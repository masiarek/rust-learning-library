...
That last one is the same manoeuvre as [`Option::take`](../option_as_collection/README.md) — leave something valid behind, and the obligation stays balanced.
...
```bash
rustc --edition 2024 01_Foundations/ownership_and_moves/examples/ownership_and_moves.rs -o /tmp/oam && /tmp/oam
```
