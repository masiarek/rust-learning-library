...
- [Shadowing and `unwrap`](../../17_Option_and_Result/shadowing_and_unwrap/README.md) — what shadowing is *for*, and the type change that makes it worth having
...
- [What a warning is asking](../../15_First_Programs/what_a_warning_is_asking/README.md) — `unused_variables`, the near-miss above, and what `_name` actually answers
