...
- [Drawing `sret`](../drawing_the_return_slot/README.md) — a reissued slot seen in lldb: the room a return value lands in holds an earlier call's bytes until the callee writes
