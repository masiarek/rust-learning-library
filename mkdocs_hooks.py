...
NAV_ORDER: dict[str, list[str]] = {
    ...
    # attribute macros, and the capstone that uses all of it.
    "37_Procedural_Macros": [
        "README.md",
        "three_kinds_of_procedural_macro",
        "expanding_thiserror",
        "function_macro_rules_or_proc_macro",
        "a_proc_macro_crate",
        "tokens_and_token_streams",
        "proc_macro2_makes_it_testable",
        "parsing_with_syn",
        "generating_with_quote",
        "the_reexport_pattern",
        "testing_with_trybuild",
        "every_struct_and_enum_shape",
        "absolute_paths_and_hygiene",
        "errors_from_panic_to_syn_error",
        "helper_attributes_by_hand",
        "helper_attributes_with_darling",
        "generics_lifetimes_and_where",
        "why_println_is_a_macro",
        "parsing_arbitrary_tokens",
        "when_macro_rules_runs_out",
        "a_routes_macro",
        "parse_tweak_reemit",
        "re_emit_on_error",
        "a_retry_attribute",
    ...
    "12_Traits/how_to_learn_to_owned": [
        ...
        "clone_vs_to_owned",
        "types_with_no_size",
        "owned_and_borrowed_types",
        "clone_returns_self",
        "the_dot_picks_first",
        "the_blanket_to_owned",
        "borrow_the_way_back",
        "to_owned_traps",
        "clone_into_refills",
        "implementing_it_or_not",
        "clone_to_owned_or_from",
        "where_clone_will_not_do",
        "to_owned_errors",
        "to_owned_lints",
...
LABELS = {
    ...
    # 37_Procedural_Macros -- most lessons are named for a crate, a macro or a
    # type, and read as code.
    "expanding_thiserror": "Expanding `thiserror`",
    "function_macro_rules_or_proc_macro": "Function, `macro_rules!` or proc macro",
    "a_proc_macro_crate": "A proc-macro crate",
    "proc_macro2_makes_it_testable": "`proc-macro2` makes it testable",
    "parsing_with_syn": "Parsing with `syn`",
    "generating_with_quote": "Generating with `quote`",
    "testing_with_trybuild": "Testing with `trybuild`",
    "errors_from_panic_to_syn_error": "Errors: `panic!` to `syn::Error`",
    "helper_attributes_with_darling": "Helper attributes with `darling`",
    "generics_lifetimes_and_where": "Generics, lifetimes and `where`",
    "why_println_is_a_macro": "Why `println!` is a macro",
    "when_macro_rules_runs_out": "When `macro_rules!` runs out",
    "a_routes_macro": "A `routes!` macro",
    "parse_tweak_reemit": "Parse, tweak, re-emit",
    "re_emit_on_error": "Re-emit the item on error",
    "a_retry_attribute": "A `#[retry]` attribute",
    "a_state_machine_derive": "A `StateMachine` derive",
    ...
    "clone_returns_self": "4 · `Clone` hands back `Self`",
    "the_dot_picks_first": "5 · The dot picks first",
    "the_blanket_to_owned": "6 · The blanket impl",
    "borrow_the_way_back": "7 · `Borrow`, the way back",
    "to_owned_traps": "8 · The traps",
    "clone_into_refills": "9 · `clone_into` refills",
    "implementing_it_or_not": "10 · Implementing it (optional)",
    "clone_to_owned_or_from": "After: `Clone`, `ToOwned` or `From`?",
    "where_clone_will_not_do": "Where `Clone` will not do",
    "to_owned_errors": "Every `ToOwned` error, fixed",
...
# is parsed, so until 2026-09-10 no page on this site carried a TAB byte. The
# Makefile on 20_Compilers/makefiles arrived with four spaces where each recipe
# TAB had been, and a copy of it failed with `missing separator`; GitHub
