...
<!-- source:forgotten_unlock_kata -->
*[`forgotten_unlock_kata.rs`](examples/forgotten_unlock_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:forgotten_unlock_kata -->
*Verified output of [`forgotten_unlock_kata.rs`](examples/forgotten_unlock_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
