...
- [Loops without an index](../../25_Control_Flow/loops_without_an_index/README.md) — the bounds check measured in assembly: present in a debug build, gone for `0..v.len()` at `opt-level=3`, and one comparison before the loop for `0..n`
