...
<!-- source:double_free_kata -->
*[`double_free_kata.rs`](examples/double_free_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:double_free_kata -->
*Verified output of [`double_free_kata.rs`](examples/double_free_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
