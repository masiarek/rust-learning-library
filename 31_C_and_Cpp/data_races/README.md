...
<!-- output:still_a_race -->
*Verified output of [`still_a_race.rs`](examples/still_a_race.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
<!-- source:data_races_kata -->
*[`data_races_kata.rs`](examples/data_races_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:data_races_kata -->
*Verified output of [`data_races_kata.rs`](examples/data_races_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
