...
| [Broken pipe](broken_pipe/README.md) | 201 | `tool \| head` closes stdout, Rust ignores `SIGPIPE`, and `println!` panics — why a command-line tool writes with `writeln!` and treats `BrokenPipe` as a quiet exit |
