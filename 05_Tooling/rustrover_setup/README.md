...
- [Automation: a training and a production lint profile](../../34_Templates/automation/README.md) — both profiles as template files, and a script that writes them into a RustRover project, remap line included
