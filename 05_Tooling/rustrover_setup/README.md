...
- [Templates](../../34_Templates/README.md) — a training and a production project to copy, clippy settings included, and a script that applies either to a RustRover project, remap line and all
