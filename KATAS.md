...
| K81 | [Predict the closure-call count, then count it — seven chains over six scores, and the three that stop early for three different reasons](23_Functional/iterators_are_lazy/README.md#practice) | [Iterators are lazy](23_Functional/iterators_are_lazy/README.md) | 201 |
