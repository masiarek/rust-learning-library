...
| K92 | [The `Vec` that could not outlive its string — read `E0515`, then fix it four ways and say what each one allocates](24_Iterators/collect_into_a_vec/README.md#practice) | [Collect the iterator into a `Vec`](24_Iterators/collect_into_a_vec/README.md) | 101 → 201 |
| K93 | [Six questions, one `Vec` — predict which of them needs a collection, then count how many pieces each one actually walked](24_Iterators/collect_into_a_vec/README.md#practice) | [Collect the iterator into a `Vec`](24_Iterators/collect_into_a_vec/README.md) | 101 → 201 |
| K94 | [Three refusals, three fixes, and the one you can delete — an `Rc` in a `spawn`, a push through a shared `Arc`, a missing per-thread clone, and the total you cannot print](18_Ownership/sharing_across_threads/README.md#practice) | [Sharing across threads: `Arc`](18_Ownership/sharing_across_threads/README.md) | 201 |
| K95 | [Predict seven sizes, then predict which of seven lines allocates — the array against the `Vec`, the three numbers that all miss the heap, and a counting allocator over move, `Copy`, borrow, clone, `Box` and `Rc`](18_Ownership/stack_and_heap/README.md#practice) | [Stack and heap](18_Ownership/stack_and_heap/README.md) | 101 → 201 |
| K96 | [Four fields, and the transposition that compiles — total a ballot two ways, then swap two fields and construct the version rustc cannot catch](26_Collections/tuples/README.md#practice) | [Tuples](26_Collections/tuples/README.md) | 101 |
| K97 | [One function, four callers — write `average` twice, find the three calls the fixed-length signature turns away, and the `0 / 0` that neither panics nor stops](26_Collections/arrays_and_slices/README.md#practice) | [Arrays and slices](26_Collections/arrays_and_slices/README.md) | 101 → 201 |
| K98 | [Count the reallocations, then delete them — a hundred pushes three ways, and the elements each one copied](26_Collections/the_vec/README.md#practice) | [`Vec`](26_Collections/the_vec/README.md) | 101 → 201 |
| K99 | [Build the same grid twice and send it the bill — a `Flat` struct against `Vec<Vec<u8>>`, the allocation count for a million cells, and the `set` that writes a real cell it was never asked for](26_Collections/vec_of_vecs/README.md#practice) | [Grids and nested `Vec`s](26_Collections/vec_of_vecs/README.md) | 201 |
| K100 | [Four ways to count, and the two that are wrong — one reports 2 for a candidate who scored 11, the other is merely three lookups per ballot](26_Collections/the_hashmap/README.md#practice) | [`HashMap`](26_Collections/the_hashmap/README.md) | 101 → 201 |
| K101 | [Who voted twice, who never voted — two answers from one operation with its arguments swapped, and the turnout formula that counts a stranger](26_Collections/the_hashset/README.md#practice) | [`HashSet`](26_Collections/the_hashset/README.md) | 201 |
| K102 | [Two orders from one tally, and the key you cannot use — the container hands you one of the two orders free, and keying on each candidate's share puts five in and gets three out](26_Collections/sorted_collections/README.md#practice) | [`BTreeMap` and `BTreeSet`](26_Collections/sorted_collections/README.md) | 101 → 201 |
| K103 | [Two walks and a drop order — the same boxed list recursively and with a cursor, then the error rustc gives when the `Box` comes out](26_Collections/the_box/README.md#practice) | [`Box`](26_Collections/the_box/README.md) | 201 |
| K104 | [Three conversions, one the compiler forbids — the orphan rule in its own words, and the `impl Into<T>` argument that also accepts the type it converts to](29_Conversion/from_and_into/README.md#practice) | [`From` and `Into`](29_Conversion/from_and_into/README.md) | 201 |
| K105 | [A ballot line parsed twice — one parser names the bad cell, the other returns a plausible ballot with a 9 on a 0-5 scale](29_Conversion/tryfrom_and_tryinto/README.md#practice) | [`TryFrom` and `TryInto`](29_Conversion/tryfrom_and_tryinto/README.md) | 201 |
| K106 | [Four silent losses — the turnout that rounds to zero, the guard a negative index walks through, and the three named adds](29_Conversion/casting_with_as/README.md#practice) | [Casting with `as`](29_Conversion/casting_with_as/README.md) | 201 |
| K107 | [The door your own module left open — three versions of one newtype, two of which let a caller build an invalid score](27_Modules/modules_and_visibility/README.md#practice) | [Modules and visibility](27_Modules/modules_and_visibility/README.md) | 201 |
| K108 | [Two traits called `Write`, and a glob that shadows — predict which line the ambiguity error lands on](27_Modules/the_use_declaration/README.md#practice) | [Bringing names in with `use`](27_Modules/the_use_declaration/README.md) | 101 → 201 |
| K109 | [Five paths to one function — `super`, `crate`, `self` and a sibling, then the fifth file that compiles and never runs](27_Modules/one_module_per_file/README.md#practice) | [One module per file](27_Modules/one_module_per_file/README.md) | 201 |
| K110 | [The address you may not rely on — two pointer comparisons that agree, only one of which is a promise](27_Modules/const_and_static/README.md#practice) | [`const` and `static`](27_Modules/const_and_static/README.md) | 201 |
| K111 | [The derive that changed behaviour when a field moved — one cosmetic diff, and every sort over the type reversed](27_Modules/what_an_attribute_is/README.md#practice) | [What an attribute is](27_Modules/what_an_attribute_is/README.md) | 201 |
| K112 | [Five assertions, two of which cannot fail — say what would have to break before each one noticed](28_Testing/what_a_test_asserts/README.md#practice) | [What a test asserts](28_Testing/what_a_test_asserts/README.md) | 201 |
| K113 | [The test that could not see it — a private helper, and a `should_panic` that goes green on the wrong panic](28_Testing/where_a_test_goes/README.md#practice) | [Where a test goes](28_Testing/where_a_test_goes/README.md) | 201 |
| K114 | [The example that documents half the sentence — then a third case the doc comment never promised at all](28_Testing/doc_tests/README.md#practice) | [The example that is a test](28_Testing/doc_tests/README.md) | 201 |
| K115 | [Four impls for one `*`, and an operator that should not exist — then three plausible readings of adding two turnout figures](12_Traits/operators_are_traits/README.md#practice) | [Operators are traits](12_Traits/operators_are_traits/README.md) | 201 |
| K116 | [Three drop orders, and the guard released one line early — two of the orders are opposites, and one binding is a bug](12_Traits/drop_and_raii/README.md#practice) | [`Drop`, and what RAII buys](12_Traits/drop_and_raii/README.md) | 201 |
| K117 | [The same fan-out three ways — sequential, `spawn` plus `Arc`, and `scope`, then the E0373 that explains why the middle one exists](09_Advanced/spawning_a_thread/README.md#practice) | [Spawning a thread](09_Advanced/spawning_a_thread/README.md) | 201 → 301 |
| K118 | [A three-stage pipeline, and the drop that ends it — then reproduce the classic mpsc hang without hanging](09_Advanced/channels/README.md#practice) | [Channels](09_Advanced/channels/README.md) | 201 → 301 |
| K119 | [The safe line the unsafe block depends on — write `split_at_mut`, delete its assert, then find the ordinary `pub fn` that makes an unchecked read unsound](09_Advanced/what_unsafe_turns_off/README.md#practice) | [What `unsafe` turns off](09_Advanced/what_unsafe_turns_off/README.md) | 301 |
| K120 | [Three calls, three causes — one `E0599` each, and only one of them is fixed by implementing the trait the method came from](12_Traits/no_method_named/README.md#practice) | ["No method named …"](12_Traits/no_method_named/README.md) | 201 |
...
- K94 · [Three refusals, three fixes, and the one you can delete](18_Ownership/sharing_across_threads/README.md#practice)
- K95 · [Predict seven sizes, then predict which of seven lines allocates](18_Ownership/stack_and_heap/README.md#practice)
...
- K117 · [The same fan-out three ways](09_Advanced/spawning_a_thread/README.md#practice)
- K118 · [A three-stage pipeline, and the drop that ends it](09_Advanced/channels/README.md#practice)
- K119 · [The safe line the unsafe block depends on](09_Advanced/what_unsafe_turns_off/README.md#practice)
...
- K115 · [Four impls for one `*`, and an operator that should not exist](12_Traits/operators_are_traits/README.md#practice)
- K116 · [Three drop orders, and the guard released one line early](12_Traits/drop_and_raii/README.md#practice)
- K120 · [Three calls, three causes](12_Traits/no_method_named/README.md#practice)
...
- K92 · [The `Vec` that could not outlive its string](24_Iterators/collect_into_a_vec/README.md#practice)
- K93 · [Six questions, one `Vec`](24_Iterators/collect_into_a_vec/README.md#practice)

**[Collections](26_Collections/README.md)** — 8 katas

- K96 · [Four fields, and the transposition that compiles](26_Collections/tuples/README.md#practice)
- K97 · [One function, four callers](26_Collections/arrays_and_slices/README.md#practice)
- K98 · [Count the reallocations, then delete them](26_Collections/the_vec/README.md#practice)
- K99 · [Build the same grid twice and send it the bill](26_Collections/vec_of_vecs/README.md#practice)
- K100 · [Four ways to count, and the two that are wrong](26_Collections/the_hashmap/README.md#practice)
- K101 · [Who voted twice, who never voted](26_Collections/the_hashset/README.md#practice)
- K102 · [Two orders from one tally, and the key you cannot use](26_Collections/sorted_collections/README.md#practice)
- K103 · [Two walks and a drop order](26_Collections/the_box/README.md#practice)

**[Conversion](29_Conversion/README.md)** — 3 katas

- K104 · [Three conversions, one the compiler forbids](29_Conversion/from_and_into/README.md#practice)
- K105 · [A ballot line parsed twice](29_Conversion/tryfrom_and_tryinto/README.md#practice)
- K106 · [Four silent losses](29_Conversion/casting_with_as/README.md#practice)

**[Modules](27_Modules/README.md)** — 5 katas

- K107 · [The door your own module left open](27_Modules/modules_and_visibility/README.md#practice)
- K108 · [Two traits called `Write`, and a glob that shadows](27_Modules/the_use_declaration/README.md#practice)
- K109 · [Five paths to one function](27_Modules/one_module_per_file/README.md#practice)
- K110 · [The address you may not rely on](27_Modules/const_and_static/README.md#practice)
- K111 · [The derive that changed behaviour when a field moved](27_Modules/what_an_attribute_is/README.md#practice)

**[Testing](28_Testing/README.md)** — 3 katas

- K112 · [Five assertions, two of which cannot fail](28_Testing/what_a_test_asserts/README.md#practice)
- K113 · [The test that could not see it](28_Testing/where_a_test_goes/README.md#practice)
- K114 · [The example that documents half the sentence](28_Testing/doc_tests/README.md#practice)
