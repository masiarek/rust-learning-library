...
| K56 | [One `&str` parameter, three callers — then flip it to `String` and catalogue what every call site now pays](01_Foundations/string_vs_str/README.md#practice) | [`String` vs `&str`](01_Foundations/string_vs_str/README.md) | 101 → 201 |
| K57 | [Cut a name in half without panicking — `len()/2` on four names, and the two ways to find a legal boundary](01_Foundations/string_slices/README.md#practice) | [String slices](01_Foundations/string_slices/README.md) | 101 → 201 |
| K58 | [Predict `len` and `capacity` through five pushes — which ones reallocate? — then make one up-front allocation serve all of them](01_Foundations/anatomy_of_a_string/README.md#practice) | [The anatomy of a `String`](01_Foundations/anatomy_of_a_string/README.md) | 101 → 201 |
| K59 | [Implement `Display` once and collect four abilities — then add `impl ToString` and read the `E0119`](01_Foundations/making_a_string/README.md#practice) | [Making a `String`](01_Foundations/making_a_string/README.md) | 101 → 201 |
| K60 | [One line built four ways — which inputs survive, how many buffers, and which one is wrong inside a loop](01_Foundations/building_a_string/README.md#practice) | [Building a `String`](01_Foundations/building_a_string/README.md) | 101 → 201 |
| K61 | [One name, three lengths — a per-`char` inventory, and the combining accent that makes two identical-looking strings unequal](01_Foundations/meet_the_char/README.md#practice) | [Meet the `char`](01_Foundations/meet_the_char/README.md) | 101 → 201 |
| K62 | [An empty field is data — parse `"5,,0"` into abstentions, then watch `split_whitespace()` shorten the row](01_Foundations/walking_a_string/README.md#practice) | [Walking a `String`](01_Foundations/walking_a_string/README.md) | 101 → 201 |
| K63 | [Return a label three ways — read the `E0515`, then match, leak, or own it, and say which one leaks in a loop](01_Foundations/static_str/README.md#practice) | [`&'static str`](01_Foundations/static_str/README.md) | 201 |
| K64 | [Three arrivals, three types — then break the UTF-8 promise and the NUL promise on purpose, and read both refusals](01_Foundations/six_kinds_of_string/README.md#practice) | [Six kinds of string](01_Foundations/six_kinds_of_string/README.md) | 201 |
| K65 | [Build the same choice twice — a hand-maintained tag beside a union, then an `enum`, and the desync only one of them can have](09_Advanced/what_a_union_is/README.md#practice) | [What a union is](09_Advanced/what_a_union_is/README.md) | 301 |
| K66 | [Seven errors, five root causes, three edits — group them by cause before changing a line](01_Foundations/when_a_struct_refuses/README.md#practice) | [When a struct refuses](01_Foundations/when_a_struct_refuses/README.md) | 101 → 201 |
| K67 | [Both `dbg!` traps — the alternate flag a hand-written `Debug` ignores, and the move that costs you the value](01_Foundations/what_dbg_does/README.md#practice) | [What `dbg!` does](01_Foundations/what_dbg_does/README.md) | 101 → 201 |
