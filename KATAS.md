...
| K60 | [Greet two people — three refusals on purpose (`E0369`, `E0308`, `E0368`), then the same sentence three ways](01_Foundations/concatenating_strings/README.md#practice) | [Concatenating strings](01_Foundations/concatenating_strings/README.md) | 101 → 201 |
| K61 | [One line built four ways — which inputs survive, how many buffers, and which one is wrong inside a loop](01_Foundations/building_a_string/README.md#practice) | [Building a `String`](01_Foundations/building_a_string/README.md) | 101 → 201 |
| K62 | [One name, three lengths — a per-`char` inventory, and the combining accent that makes two identical-looking strings unequal](01_Foundations/meet_the_char/README.md#practice) | [Meet the `char`](01_Foundations/meet_the_char/README.md) | 101 → 201 |
| K63 | [An empty field is data — parse `"5,,0"` into abstentions, then watch `split_whitespace()` shorten the row](01_Foundations/walking_a_string/README.md#practice) | [Walking a `String`](01_Foundations/walking_a_string/README.md) | 101 → 201 |
| K64 | [Return a label three ways — read the `E0515`, then match, leak, or own it, and say which one leaks in a loop](01_Foundations/static_str/README.md#practice) | [`&'static str`](01_Foundations/static_str/README.md) | 201 |
| K65 | [Three arrivals, three types — then break the UTF-8 promise and the NUL promise on purpose, and read both refusals](01_Foundations/six_kinds_of_string/README.md#practice) | [Six kinds of string](01_Foundations/six_kinds_of_string/README.md) | 201 |
