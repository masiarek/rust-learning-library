...
| K57 | [Predict `len` and `capacity` through five pushes — which ones reallocate? — then make one up-front allocation serve all of them](01_Foundations/anatomy_of_a_string/README.md#practice) | [The anatomy of a `String`](01_Foundations/anatomy_of_a_string/README.md) | 101 → 201 |
| K58 | [One name, three lengths — a per-`char` inventory, and the combining accent that makes two identical-looking strings unequal](01_Foundations/meet_the_char/README.md#practice) | [Meet the `char`](01_Foundations/meet_the_char/README.md) | 101 → 201 |
| K59 | [Three arrivals, three types — then break the UTF-8 promise and the NUL promise on purpose, and read both refusals](01_Foundations/six_kinds_of_string/README.md#practice) | [Six kinds of string](01_Foundations/six_kinds_of_string/README.md) | 201 |
