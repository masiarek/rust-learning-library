...
| No overhead FFI | `extern "C"` is an ordinary C call. No marshalling layer, no JNI, no `ctypes` — and no runtime on your side to start up first | [Calling C](../../09_Advanced/calling_c/README.md) |
