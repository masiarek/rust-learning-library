...
| [Seven kinds of file](seven_kinds_of_file/README.md) | 201 | Regular, directory, symlink, FIFO, socket, and two devices — `file_type()` and `FileTypeExt` name them, `symlink_metadata` does not follow, and `File::open` on a directory *succeeds* |
