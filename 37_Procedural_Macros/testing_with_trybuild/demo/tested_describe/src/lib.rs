...
/// The derive macro. It lives in `tested_describe_derive`, because a proc-macro crate
/// can export nothing but macros; this line makes it `tested_describe::Describe` too.
pub use tested_describe_derive::Describe;
