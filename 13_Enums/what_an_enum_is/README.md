...
<!-- source:what_an_enum_is_kata -->
*[`what_an_enum_is_kata.rs`](examples/what_an_enum_is_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:what_an_enum_is_kata -->
*Verified output of [`what_an_enum_is_kata.rs`](examples/what_an_enum_is_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
