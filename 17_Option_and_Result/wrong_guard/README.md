...
<!-- source:wrong_guard_kata -->
*[`wrong_guard_kata.rs`](examples/wrong_guard_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:wrong_guard_kata -->
*Verified output of [`wrong_guard_kata.rs`](examples/wrong_guard_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
```bash
rustc --edition 2024 17_Option_and_Result/wrong_guard/examples/wrong_guard.rs -o /tmp/wg && /tmp/wg
```
