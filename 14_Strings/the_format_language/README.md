...
<!-- source:justify_text_kata -->
*[`justify_text_kata.rs`](examples/justify_text_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:justify_text_kata -->
*Verified output of [`justify_text_kata.rs`](examples/justify_text_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
