...
<!-- source:replace_all_kata -->
*[`replace_all_kata.rs`](examples/replace_all_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:replace_all_kata -->
*Verified output of [`replace_all_kata.rs`](examples/replace_all_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
