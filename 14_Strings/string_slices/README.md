...
<!-- source:interleave_kata -->
*[`interleave_kata.rs`](examples/interleave_kata.rs) in full — pasted here by `tools/run_examples.py` from the file CI compiles and runs.*
...
<!-- output:interleave_kata -->
*Verified output of [`interleave_kata.rs`](examples/interleave_kata.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
